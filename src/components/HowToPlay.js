...
const HowToPlay = () => {
  return (
    <div className="HowToPlay">
      ...
      <section>
        <h3> 1. Enter the Battle</h3>
        <p>
          Each week, a new battle opens with a monologue prompt. Choose your
          battle, accept the challenge, and get ready to perform.
        </p>
      </section>
      <section>
        <h3>2. Record Your Self Tape</h3>
        <p>
          Film your monologue in your own time, on your own setup. No pressure.
          No rush. Just your best work.
        </p>
      </section>
